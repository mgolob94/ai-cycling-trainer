-- Pending migrations bundle — paste into the Supabase SQL Editor and Run.
-- Generated 2026-05-30. Covers the 3 not-yet-applied migrations.

-- ===== 20260530030000_ai_insights.sql =====
...
-- ===== 20260530040000_ride_ai_analysis.sql =====
-- Per-ride AI analysis (execution score, feedback, etc.).
alter table public.rides
  add column if not exists ai_analysis jsonb;

-- ===== 20260530050000_user_periodization.sql =====
